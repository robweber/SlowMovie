...
parser.add_argument(
    "-d", "--delay", default=120, help="Delay between screen updates, in seconds"
)
parser.add_argument(
    "-i", "--inc", default=4, help="Number of frames skipped between screen updates"
)
parser.add_argument("-s", "--start", help="Start at a specific frame")
parser.add_argument(
    "-l", "--saturation", default=0.25, help="Saturation level between 0 and 1"
)
